        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <Card className="bg-gray-800 border-gray-700 shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl font-medium text-white">TCP/UDP流量代理防禦方案</CardTitle>
              ...
              <CardContent className="space-y-6">
                <ul className="space-y-3 text-left">
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-300 font-normal">非計量 DDoS 防護</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">TCP/UDP 協議支援</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">全球 330 個位置覆蓋</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">智能流量加速</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">24/7 即時監控</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">自動路由優化</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" style={{ color: "#0D99FF" }} />
                    <span className="text-gray-300 font-normal">詳細性能報告</span>
                  </li>
                </ul>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="shadow-lg bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">過去6個月的TCP/UDP流量和攻擊阻擋</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
        ...
        <Card className="shadow-lg bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">延遲時間和服務可用性改善</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-1 shadow-lg bg-gray-800 border-gray-700">
          <CardHeader>
            <CardTitle className="text-xl text-white">協議分佈</CardTitle>
            <CardDescription className="text-gray-300">TCP vs UDP 流量比例</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-2 shadow-lg bg-gray-800 border-gray-700">
          <CardHeader>
            <CardTitle className="text-xl text-white">攻擊類型分析</CardTitle>
            <CardDescription className="text-gray-300">過去6個月的攻擊類型統計</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
